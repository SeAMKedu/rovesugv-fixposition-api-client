...
Python-asiakasohjelma Fixposition Vision-RTK 2 -laitteen API:lle

## Fixposition API

Fixposition-laitteen ohjelmointirajapinnan dokumentaatio on saatavilla osoitteessa [https://docs.fixposition.com/fd/api-documentation](https://docs.fixposition.com/fd/api-documentation).
